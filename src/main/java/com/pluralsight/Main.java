...
public class Main{
    ...
    private final static ProductFileManager productFileManager = new ProductFileManager("src/main/java/com/pluralsight/data/product.txt");

    public static void main(String[] arg) throws IOException {
        ArrayList<Product> products = productFileManager.loadProduct();
...
//   Product Menu System
    ...
    public static void addNewProduct(ArrayList<Product> products) {
        ...
        try {
            productFileManager.writeProduct(addNewProduct);
        } catch (IOException e){
